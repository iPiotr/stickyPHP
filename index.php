...
<body>
  <div class="form">
    <ul class="tab-group">
      <li class="tab active"><a href="#signup" id="left">Sign Up</a></li>
      <li class="tab"><a href="#login" id="right">Log In</a></li>
    </ul>
    <?php echo $error; ?>
      ...
      <div id="signup">
        ...
        <form action='' method='post'>
          ...
          <div class="field-wrap">
            ...
            <input name="usernameS" value="<?php echo $usernameS; ?>" type="text" maxlength="16" required
              autocomplete="off" />
          </div>
      ...
      <div id="login">
        ...
        <form action="" method="post">
          ...
          <div class="field-wrap">
            ...
            <input name="usernameL" value="<?php echo $usernameL; ?>" type="text" maxlength="16" required
              autocomplete="off" />
          </div>
